...
open_run impl_1
write_bitstream -force fpga.runs/impl_1/${fpga_top_name}_${current_time}_${tag}.bit
write_debug_probes -force fpga.runs/impl_1/${fpga_top_name}_${current_time}_${tag}.ltx
