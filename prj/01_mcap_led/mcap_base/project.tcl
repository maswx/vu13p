...
#
# Generated by Vivado on Mon Mar 13 01:22:39 CST 2023
...
#
#    "/home/masw/work/gitwork/alivu13p/prj/01_mcap_led/mcap_base/project.srcs/sources_1/bd/pcie_base/pcie_base.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project.srcs/sources_1/bd/pcie_base/pcie_base.bd"]"\
  ]
  foreach ifile $files {
...
if { [get_property IS_LOCKED [ get_files -norecurse pcie_base.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project.gen/sources_1/bd/pcie_base/hdl/pcie_base_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse pcie_base.bd] -top]
...
set file "pcie_base/pcie_base.bd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcie_base_wrapper" -objects $obj
