...
#
# prj.tcl: Tcl script for re-creating project 'project'
#
# Generated by Vivado on Fri Mar 10 23:46:11 CST 2023
...
#
#    "/home/masw/work/gitwork/alivu13p/prj/04_pcie_ddr4/project.srcs/sources_1/bd/base/base.bd"
#    "/home/masw/work/gitwork/alivu13p/prj/04_pcie_ddr4/project.srcs/utils_1/imports/synth_1/base_wrapper.dcp"
#
...
#    "/home/masw/work/gitwork/alivu13p/xdc/alivu13p_c3_ddr4.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project.srcs/sources_1/bd/base/base.bd"]"\
 "[file normalize "$origin_dir/project.srcs/utils_1/imports/synth_1/base_wrapper.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/../../xdc/alivu13p_c3_ddr4.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
if { [get_property IS_LOCKED [ get_files -norecurse base.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project.gen/sources_1/bd/base/hdl/base_wrapper.v" ]
} else {
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../xdc/alivu13p_c3_ddr4.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../xdc/alivu13p_c3_ddr4.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
