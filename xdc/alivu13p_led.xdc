...
set_property PACKAGE_PIN BB24 [get_ports {led[7]}]
set_property PACKAGE_PIN BA24 [get_ports {led[6]}]
set_property PACKAGE_PIN BC22 [get_ports {led[5]}]
set_property PACKAGE_PIN BB22 [get_ports {led[4]}]
set_property PACKAGE_PIN BC21 [get_ports {led[3]}]
