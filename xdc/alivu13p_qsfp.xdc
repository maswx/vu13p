...
# 参考ug575 P345 :  BANK 233  主要分布在(A/B/C/D/E)(1~11)
set_property PACKAGE_PIN E9  [get_ports {up_qsfp0_tx_p}] ; # 若使用8线MPO，对应 1 号线
set_property PACKAGE_PIN E8  [get_ports {up_qsfp0_tx_n}] ; # 若使用8线MPO，对应 1 号线
set_property PACKAGE_PIN D7  [get_ports {up_qsfp1_tx_p}] ; # 若使用8线MPO，对应 2 号线
set_property PACKAGE_PIN D6  [get_ports {up_qsfp1_tx_n}] ; # 若使用8线MPO，对应 2 号线
set_property PACKAGE_PIN C9  [get_ports {up_qsfp2_tx_p}] ; # 若使用8线MPO，对应 3 号线
set_property PACKAGE_PIN C8  [get_ports {up_qsfp2_tx_n}] ; # 若使用8线MPO，对应 3 号线
set_property PACKAGE_PIN A9  [get_ports {up_qsfp3_tx_p}] ; # 若使用8线MPO，对应 4 号线
set_property PACKAGE_PIN A8  [get_ports {up_qsfp3_tx_n}] ; # 若使用8线MPO，对应 4 号线
set_property PACKAGE_PIN E4  [get_ports {up_qsfp0_rx_p}] ; # 若使用8线MPO，对应 5 号线
set_property PACKAGE_PIN E3  [get_ports {up_qsfp0_rx_n}] ; # 若使用8线MPO，对应 5 号线
set_property PACKAGE_PIN D2  [get_ports {up_qsfp1_rx_p}] ; # 若使用8线MPO，对应 6 号线
set_property PACKAGE_PIN D1  [get_ports {up_qsfp1_rx_n}] ; # 若使用8线MPO，对应 6 号线
set_property PACKAGE_PIN C4  [get_ports {up_qsfp2_rx_p}] ; # 若使用8线MPO，对应 7 号线
set_property PACKAGE_PIN C3  [get_ports {up_qsfp2_rx_n}] ; # 若使用8线MPO，对应 7 号线
set_property PACKAGE_PIN A5  [get_ports {up_qsfp3_rx_p}] ; # 若使用8线MPO，对应 8 号线
set_property PACKAGE_PIN A4  [get_ports {up_qsfp3_rx_n}] ; # 若使用8线MPO，对应 8 号线
...
set_property PACKAGE_PIN AA9 [get_ports {dn_qsfp0_tx_p}] ; # 若使用8线MPO，对应 1 号线  
set_property PACKAGE_PIN AA8 [get_ports {dn_qsfp0_tx_n}] ; # 若使用8线MPO，对应 1 号线
set_property PACKAGE_PIN Y7  [get_ports {dn_qsfp1_tx_p}] ; # 若使用8线MPO，对应 2 号线
set_property PACKAGE_PIN Y6  [get_ports {dn_qsfp1_tx_n}] ; # 若使用8线MPO，对应 2 号线
set_property PACKAGE_PIN W9  [get_ports {dn_qsfp2_tx_p}] ; # 若使用8线MPO，对应 3 号线
set_property PACKAGE_PIN W8  [get_ports {dn_qsfp2_tx_n}] ; # 若使用8线MPO，对应 3 号线
set_property PACKAGE_PIN V7  [get_ports {dn_qsfp3_tx_p}] ; # 若使用8线MPO，对应 4 号线
set_property PACKAGE_PIN V6  [get_ports {dn_qsfp3_tx_n}] ; # 若使用8线MPO，对应 4 号线
set_property PACKAGE_PIN AA4 [get_ports {dn_qsfp0_rx_p}] ; # 若使用8线MPO，对应 5 号线
set_property PACKAGE_PIN AA3 [get_ports {dn_qsfp0_rx_n}] ; # 若使用8线MPO，对应 5 号线
set_property PACKAGE_PIN Y2  [get_ports {dn_qsfp1_rx_p}] ; # 若使用8线MPO，对应 6 号线
set_property PACKAGE_PIN Y1  [get_ports {dn_qsfp1_rx_n}] ; # 若使用8线MPO，对应 6 号线
set_property PACKAGE_PIN W4  [get_ports {dn_qsfp2_rx_p}] ; # 若使用8线MPO，对应 7 号线
set_property PACKAGE_PIN W3  [get_ports {dn_qsfp2_rx_n}] ; # 若使用8线MPO，对应 7 号线
set_property PACKAGE_PIN V2  [get_ports {dn_qsfp3_rx_p}] ; # 若使用8线MPO，对应 8 号线
set_property PACKAGE_PIN V1  [get_ports {dn_qsfp3_rx_n}] ; # 若使用8线MPO，对应 8 号线
